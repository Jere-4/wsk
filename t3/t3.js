...
const renderInfo = () => {
  ...
  li3.innerHTML = `Available browser screen width / height: ${screen.availWidth} / ${screen.availHeight}`;
  target.appendChild(li3);

  const li4 = document.createElement('li');
  li4.innerHTML = `Current browser screen width / height: ${window.innerWidth} / ${window.innerHeight}`;
